...
git clone https://github.com/anant-goel/kernel_xiaomi_veux-headers --depth=1 -b thirteen kernel/xiaomi/sm6375 || { echo "ERROR: Failed to Clone the Kernel Trees!" && exit 1; }
